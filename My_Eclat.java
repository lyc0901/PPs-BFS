    ...
    public Itemsets runAlgorithm(String output, TransactionDatabase database, double minsupp,
        ...
        Collections.sort(frequentitems, new Comparator<Integer>() {
            ...
            public int compare(Integer arg0, Integer arg1) {
                return mapItemTIDS.get(arg1).support - mapItemTIDS.get(arg0).support;
            }});
        //System.out.println();
        // // List<Integer>  List<String>，not toString
                    ...
                    for (String items_K : row) {
                        ...
                        if (item_list.length == 2) {
                            ...
                            if (frequent_layer_itemsetMap.containsKey(items_4) && frequent_layer_itemsetMap.containsKey(items_5)) {
                                ...
                                }else if (items_5_set.support == item_I_set.support){       //pruning 2
                                    items_45_set = frequent_layer_itemsetMap.get(items_4);
                                } else {
                                    items_45_set = performAND_rb(items_4_set, items_5_set);  // DCBA
                                    //items_45_support = items_45_set.support;
                                }

                                if (items_45_set.support >= this.minsupRelative) {
...
//                            String items_2 = item_I;
//
//                            StringBuilder sb1 = new StringBuilder();
//                            sb1.append(items_2);
//                            for (int l = 0; l < item_list.length-1; l++) {
//                                sb1.append(" ").append(item_list[l]);
//                            }
//                            String items_4 = sb1.toString();
//
//                            StringBuilder sb2 = new StringBuilder();
//                            sb2.append(items_2);
//                            for (int s = 0; s < item_list.length-2; s++) {
//                                sb2.append(" ").append(item_list[s]);
//                            }
//                            sb2.append(" ").append(item_list[item_list.length-1]);
//                            String items_5 = sb2.toString()
...
//                                int items_45_support = items_45_set.support;
                                ...
                                if (items_45_set.support >= minsupRelative) {
                                    String item_IK = item_I + " " + items_K; // 假设items_K的值是"some_value_K"
    ...
    BitSetSupport performANDFirstTime_rb(BitSetSupport tidsetI,
        ...
        bitsetSupportIJ.support = bitsetSupportIJ.bitset.getCardinality();
        // return the new tidset
